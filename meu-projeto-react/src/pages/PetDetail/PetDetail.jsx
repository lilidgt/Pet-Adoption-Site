                        ...
                        <div className="info-card stats-card">
                            <div className="stats-grid-display">
                                ...
                                <div className="stat-display-item">
                                    ...
                                    <div>
                                        ...
                                        <p className="stat-display-value">{pet.castrated ? 'Sim' : 'Não'}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="pet-tags-list">
                                {pet.personality ? (
                                    ...
                                    pet.personality.replace(/"/g, "").split(',').map((trait, index) => (
                                        <span key={index} className="pet-tag-item">
                                            {trait.trim()} {/* .trim() remove espaços em branco invisíveis */}
                                        </span>
                                    ))
                                ) : (
                            ...
                            <button className="info-card btn-contact-submit"
                                onClick={() => {
                                    ...
                                    if (pet?.contact) {
                                        ...
                                        const mensagem = encodeURIComponent(`Olá! Vi o anúncio do ${pet.name} no site de adoção e gostaria de saber mais informações.`);
